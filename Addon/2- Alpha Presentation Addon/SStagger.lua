...
function getdescript(arg, filenameha)
...
--f.text2 = f.text2 or f:CreateFontString(nil,"ARTWORK","QuestFont")
--f.text2:SetTextColor(1,1,1,1)
--f.text2:SetText(format("Enter Description "))
--f.text2:SetPoint("CENTER", -100, 25)
--f.text2:SetFontObject("ChatFontNormal")

--f.text3 = f.text3 or f:CreateFontString(nil,"ARTWORK","QuestFont")
--f.text3:SetTextColor(1,1,1,1)
--f.text3:SetText(format("Enter Tags "))
--f.text3:SetPoint("CENTER", 100, 25)
--f.text3:SetFontObject("ChatFontNormal")

f.text4 = f.text2 or f:CreateFontString(nil,"ARTWORK","QuestFont")
f.text4:SetTextColor(1,1,1,1)
f.text4:SetText(format("SStagger v 0.069\n11/22/16\nkaylo mathrax swagchard"))
